...
const EditTeacherModal = ({ isOpen, onClose, fetchData, selectedTeacher }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            fetchData();
            onClose();
            toast.success("Berhasil Mengedit data Guru dan staff!", {
                position: "top-center",
                duration: 5000,
              });
            } catch (error) {
              toast.error("Gagal Mengedit data Guru dan staff!", {
                position: "top-center",
                duration: 5000,
              });
            }
            ...
            <div className="bg-white w-full max-w-3xl p-8 rounded-md shadow-lg max-h-screen overflow-y-auto">
                ...
                <form onSubmit={handleSubmit} className="p-6 relative">
                    <div className="text-center mb-10">
                        <h3 className="text-2xl font-bold tracking-wider text-gray-800">Edit Data Guru / Staff</h3>
                    </div>
