                ...
                <div className="p-6 relative">
                    ...
                    <div className="flex justify-center mb-10">
                        <div className="w-24 h-32 border-2 border-gray-400 rounded-lg overflow-hidden shadow-md">
                            <img alt="Student Photo" className="w-full h-full object-cover" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-4 text-gray-700">
                        <div>
                            ...
                            <p><strong>Departemen:</strong> {student.departmen.nama}</p>
                    ...
                    <div className="mt-10">
                        ...
                        <div className="flex justify-between mt-4">
                            <div className="w-24 h-32 border-2 border-gray-400 rounded-lg overflow-hidden shadow-md">
                                <img alt="scan ijazah smp" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-24 h-32 border-2 border-gray-400 rounded-lg overflow-hidden shadow-md">
                                <img alt="scan akte kelahiran" className="w-full h-full object-cover" />
                            </div>
                            <div className="w-24 h-32 border-2 border-gray-400 rounded-lg overflow-hidden shadow-md">
                                <img alt="scan katu Keluarga" className="w-full h-full object-cover" />
                            </div>
                        </div>
                    </div>
                </div>
